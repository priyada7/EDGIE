function [phBase,pwBase,eBase,pdBase]=evSimulationSummer(K,n2,e0,p0,eMin,eMax,pcMax,a2,tau,etac,etad,dt,ec,onRoad,atHome,atWork,atGrocery,groceryEnergy,atErrands,errandEnergy)
