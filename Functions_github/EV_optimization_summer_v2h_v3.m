...
atGrocery,groceryEnergy,atErrands,errandEnergy,lambda)
...
minimize( ...
  ...
  +   (1/K )*dt*EnergyCommercial*sum(workLoadSummer) ...                          % Energy usage cost
    + lambda*960*pos(FutureHeadroom*max(homeLoadSummer) - TodaysHeadroom*SummerPeak) ...            % Summer peak violation penalty
    + lambda*960*pos(FutureHeadroom*max(workLoadSummer) - TodaysHeadroom*SummerPeakComStock) ... 
