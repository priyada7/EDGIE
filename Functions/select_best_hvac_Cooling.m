function [cooling_val_95F, cooling_val_82F, heating_val_5C, heating_val_45C] = select_best_hvac_Cooling(x_target, y_target)
   ...
   % Define available files
    file_list = {'2ton_R_cooling.csv', '2ton_trane_cooling.csv', ...
        '3ton_C_cooling.csv', '3ton_R_cooling.csv', '3ton_T_cooling.csv', ...
        '4ton_C_cooling.csv', '4ton_R_cooling.csv', '4ton_T_cooling.csv', ...
        '5ton_C_cooling.csv', '5ton_R_cooling.csv', '5ton_T_cooling.csv',...
        '6ton_C_cooling.csv', '6ton_R_cooling.csv', '6ton_T_cooling.csv',...
        '7ton_C_cooling.csv', '7ton_R_cooling.csv', '7ton_T_cooling.csv',...
        '8ton_C_cooling.csv', '8ton_R_cooling.csv', '8ton_T_cooling.csv'};
