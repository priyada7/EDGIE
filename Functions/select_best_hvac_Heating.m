...
function [cooling_val_95F, cooling_val_82F, heating_val_5C, heating_val_45C] = select_best_hvac_Heating(x_target, y_target)
   ...
   heating_files = {...
    '2ton_rheem_heating.csv', '2ton_trane_heating.csv', ...
    '3ton_carrier_heating.csv', '3ton_rheem_heating.csv', '3ton_trane_heating.csv', ...
    '4ton_carrier_heating.csv', '4ton_rheem_heating.csv', '4ton_trane_heating.csv', ...
    '5ton_carrier_heating.csv', '5ton_rheem_heating.csv', '5ton_trane_heating.csv',...
    '6ton_carrier_heating.csv', '6ton_rheem_heating.csv', '6ton_trane_heating.csv',...
    '7ton_carrier_heating.csv', '7ton_rheem_heating.csv', '7ton_trane_heating.csv',...
    '8ton_carrier_heating.csv', '8ton_rheem_heating.csv', '8ton_trane_heating.csv'};

    % Temperature range for heating
    temp_min_heating = f2c(5);
    temp_max_heating = f2c(48);
