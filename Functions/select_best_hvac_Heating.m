...
function [cooling_val_95F, cooling_val_82F, heating_val_5C, heating_val_45C] = select_best_hvac_Heating(x_target, y_target)
   ...
   heating_files = {...
    '2ton_A_heating.csv', '2ton_B_heating.csv', ...
    ...
    '6ton_C_heating.csv', '6ton_A_heating.csv', '6ton_B_heating.csv',...
    '7ton_C_heating.csv', '7ton_A_heating.csv', '7ton_B_heating.csv',...
    '8ton_C_heating.csv', '8ton_A_heating.csv', '8ton_B_heating.csv'};
