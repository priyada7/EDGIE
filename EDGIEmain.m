...
if warmupDays > 0
            ...
            pdBaseSummer=pdBaseSummer(warmupSteps+1:end,:);
            pdBaseWinter=pdBaseWinter(warmupSteps+1:end,:);
...
headers = {
    ...
    'R_detached', 'R_attached','Design Temp Heating (F)','Design Temp Cooling (F)','TodaysPeak  (MW)','Electrified Winter peak (MW)',...
    ...
    'CommercialSummerPeak (MW)','UpgradeReqCommercial (MW)','Commercial Cost','TotaCostCommercial'
};
